...
class AACHER(object):
    def __init__(self, state_dim, action_dim, max_action, discount, tau, hidden_sizes, num_actors=10, num_critics=10, actor_lr=3e-4, critic_lr=3e-4, smr_ratio=10, rc_weight=0.005):
